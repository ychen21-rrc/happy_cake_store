ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Happy Cake Store"
  ...
  # up your own assets / JS like this:
  #
  #   config.register_stylesheet 'my_stylesheet.css'
  #   config.register_javascript 'my_javascript.js'
  
  config.register_javascript "https://unpkg.com/trix@2.0.0/dist/trix.umd.min.js"
  config.register_stylesheet "https://unpkg.com/trix@2.0.0/dist/trix.css"
